const exploreSection = () => {
  return (
    <div className="laptop:pt-28 mobile:pt-14 mobile:px-3 laptop:px-0">
      <section className="flex laptop:flex-row mobile:flex-col mobile:gap-3 laptop:justify-between laptop:pl-28">
        <div className="flex flex-col laptop:gap-8 pt-28 ">
          ...
          <p className=" laptop:text-xl mobile:text-sm inline-block mobile:pt-8 mobile:pb-12 laptop:pt-0 mobile:text-nowrap ">
            ...
            <span className="text-plore-darkGreen ">Explore destinations</span>
          </p>
        </div>
...
const destinationSection = () => {
  return (
    <div className="mt-5 laptop:mt-15 bg-plore-accent2 mb-16 pb-7 laptop:mb-28 laptop:pb-12">
...
const retreatSection = () => {
  return (
    <div>
      ...
      <div className="flex flex-col laptop:flex-row laptop:justify-center laptop:gap-56 pt-16 laptop:pt-0 gap-10 px-6  laptop:px-32 pb-10 laptop:pb-14">
        ...
        <section className="flex flex-col gap-10 laptop:gap-10">
          <p className="font-semibold laptop:text-2xl text-lg text-[#355255]">
            What better way to improve your organisation’s culture than to have
            a retreat. Have fun and experience an adventure beyond the confines
            of the office.
          </p>
      ...
      <img className="laptop:block mobile:hidden" src="/img/Email.png" alt="" />
      <img
...
const testimonialSection = () => {
  return (
    <div className="pt-16 laptop:pt-20 laptop:px-40 px-6">
      <div className="flex flex-col laptop:flex-row">
        <section className="py-10 laptop:py-14 laptop:px-12 px-5 bg-plore-darkGreen rounded-t-lg flex flex-col gap-6">
          ...
          <p className="text-2xl laptop:text-3xl text-plore-white">I found a reason to live</p>
          <p className="font-medium text-base pb-5 text-plore-white laptop:text-xl">
            I few months back, i was considering suscide. Live felt unbearable
            and lonely. I was opportuned to come across a group trip to Obudu
            Resort, i made new friends and found a community of people. Now we
            are planning a new group trip soon.
          </p>
